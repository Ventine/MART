...
function AreaDeTrabajo() {
    return (
        <div className="h-[80vh] flex flex-col sm:flex-row ml-5"> {/*Dashboard*/}
            ...
            ">
                <div className="flex flex-col gap-6">
                    <h1 className=" text-2xl md:text-5xl xl:text-6xl  font-bold leading-[3.5rem] md:leading-[5.5rem] xl:leading-[6.5rem] text-center">Generador de horarios
                        <span className="text-purple-600 py-2 px-4 border-4 border-purple-700 relative rounded-lg ml-2 bg-white">Automático</span></h1>
            ...
            rounded-full -z-10 flex md:hidden lg:flex
             " />
                <TfiCheckBox className="w-20 h-20 object-cover text-purple-600 absolute top-[6%] right-[22%] rotate-6 hidden md:flex" />
                <TfiRulerAlt className="w-20 h-20 object-cover text-purple-600 absolute top-[12%] left-[13%] hidden md:flex" />
                <TfiFiles className="w-20 h-20 object-cover text-purple-600 absolute top-[81%] right-[36%] -rotate-3 hidden md:flex" />
