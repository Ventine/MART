                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                                    <h3 className="text-3xl font-semibold text-lime-600 ml-5">
                                        Iniciar Sesión
                                    </h3>
                                    <button
                                ...
                                <div className="relative p-6 flex-auto">
                                    <form>
                                        <div className="relative mt-2">
                                            ...
                                            <input type="text" className="bg-blue-50 py-2 pl-9 pr-6 outline-none rounded-lg w-full"  placeholder="Usuario" />
                                        </div>
                                        <div className="relative mt-2">
                                            <TfiKey className="absolute left-2 top-3" />
                                            <input type="password" className="bg-blue-50 py-2 pl-9 pr-6 outline-none rounded-lg w-full"  placeholder="Contraseña" />
                                        </div>
                                    </form>
                                </div>
                                {/*footer*/}
