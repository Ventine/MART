                                ...
                                <div className="relative p-4 flex-auto">
                                    <div className="flex justify-center m-3">
                                        <div className="block p-2 rounded-lg shadow-lg bg-white max-w-sm">
                                            <h5 className="text-purple-900 text-xl leading-tight font-medium mb-2">1 mes
                                                - 10.000 COP</h5>
                                            ...
                                            <button type="button"
                                                    ...
                                                    focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out">Comprar
                                            </button>
                                        </div>
                                    </div>
                                    <div className="flex justify-center m-3">
                                        <div className="block p-2 rounded-lg shadow-lg bg-white max-w-sm">
                                            <h5 className="text-amber-900 text-xl leading-tight font-medium mb-2">6
                                                meses - 50.000 COP</h5>
                                            <p className="text-gray-700 text-base mb-4">
                                            ...
                                            <button type="button"
                                                    ...
                                                    focus:outline-none focus:ring-0 active:bg-amber-800 active:shadow-lg transition duration-150 ease-in-out">Comprar
                                            </button>
                                        </div>
                                    </div>
                                    <div className="flex justify-center m-3">
                                        <div className="block p-2 rounded-lg shadow-lg bg-white max-w-sm">
                                            <h5 className="text-emerald-900 text-xl leading-tight font-medium mb-2">1
                                                año - 90.000 COP</h5>
                                            <p className="text-gray-700 text-base mb-4">
                                                Ilimitadas Personalizaciones y descarga en formato PDF, JPG, PNG, XML,
                                                DOC y EXCEL.
                                            </p>
                                            <button type="button"
                                                    ...
                                                    focus:outline-none focus:ring-0 active:bg-emerald-800 active:shadow-lg transition duration-150 ease-in-out">Comprar
                                            </button>
                                        </div>
                                    </div>
                                </div>
