    ...
    return(
        <div className="w-full flex flex-col md:flex-row justify-center items-center md:items-start">
            <div className="w-[40%] mb-3">
                <div className="bg-white hover:bg-amber-50 border flex flex-col max-w-sm mx-auto rounded-lg shadow-lg hover:shadow-xl m-auto">
                ...
                ">
                    ...
                    <div className="bg-purple-700 mx-4 rounded-lg flex items-center gap-2 -mt-8 z-1 shadow-xl py-2 px-6 hidden md:flex">
            ...
            <div className="w-[60%]">
                <div className="bg-white hover:bg-amber-50 border flex flex-col mr-5 rounded-lg shadow-lg hover:shadow-xl m-auto">
