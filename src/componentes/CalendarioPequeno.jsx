...
//Calendario pequeño generado al lado izquierdo del calendario grande en la pagina Horario
    ...
    return (
        <div className="mt-3 ">
            <header className="flex justify-between ">
                ...
                <button className="cursor-pointer text-purple-600 mx-2" onClick={handleNextMes}><TfiAngleRight/>
                </button>
            </header>
